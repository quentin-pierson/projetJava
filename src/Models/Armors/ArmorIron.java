...
public class ArmorIron extends Armor{
    ...
    public ArmorIron(int health, int armor, int level, int rateAttack, int damage, int lucky, int mana, int dodge, ArmorType armorType, String name, String description, int durability, int price) {
