...
public class Weapon extends Abilities {
    ...
    public Weapon(int health, int armor, int level, int rateAttack, int damage, int lucky, int mana, int dodge, WeaponType weaponType, String name, String description, int price) {
